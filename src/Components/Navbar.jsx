...
const Navbar = () => {
    ...
    return (
        <header className="w-full relative">
            ...
            <div className="bg-black text-gray-200 py-1 px-0 flex flex-wrap justify-center md:justify-between items-center border-b border-gray-800 gap-2 md:gap-0">
                ...
                <div className="flex space-x-3 ml-auto md:ml-0">
                    ...
                    <a href="https://wa.me/50670799463" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-400 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4" fill="currentColor" viewBox="0 0 24 24">
